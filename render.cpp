...
namespace fonts
{
	...
	ImFont* Watermark2;
	ImFont* SmallPixelWatermark;
	ImFont* WTLG;
	ImFont* AADebug;
	ImFont* EventLog;
	ImFont* NewIconsNotify;
	ImFont* NewIconsNotify2;
	ImFont* NotifyBold;
	ImFont* CloudIndi;
	ImFont* MenuIcons;
	ImFont* NotifyMore;
...
void Drawing::CreateFonts()
{
	...
	LastFontName = "Corbel";
	interfaces.surfaces->SetFontGlyphSet(fonts::esp_name = interfaces.surfaces->Create_Font(), "Corbel", 14, 400, 0, 0, FONTFLAG_DROPSHADOW);
	...
	LastFontName = "espicons";
	interfaces.surfaces->SetFontGlyphSet(fonts::esp_icon = interfaces.surfaces->Create_Font(), "espicons", 16, 500, 0, 0, FONTFLAG_ANTIALIAS);

	LastFontName = "Small Fonts";
	interfaces.surfaces->SetFontGlyphSet(fonts::esp_logs = interfaces.surfaces->Create_Font(), "Small Fonts", 15, 400, 0, 0, FONTFLAG_DROPSHADOW);
