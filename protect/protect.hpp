...
namespace hs {
	...
	_(is_Line_goes_through_smoke, "55 8B EC 83 EC 08 8B 15 ? ? ? ? 0F 57 C0");
	...
	_(update_clientside_anim_p, "55 8B EC 51 56 8B F1 80 BE ? ? ? ? ? 74 36"); // 55 8B EC 51 56 8B F1 80 BE ?? ?? 00 00 00 74 36 8B 06 FF 90 ?? ?? 00 00
	...
	_(should_skip_anim_frame_p, "57 8B F9 8B 07 8B ? ? ? ? ? FF D0 84 C0 75"); // 57 8B F9 8B 07 8B 80 ? ? ? ? FF D0 84 C0 75 02
	...
	_(shoot_pos, "55 8B EC 56 8B 75 08 57 8B F9 56 8B 07 FF ? ? ? ? ? 80"); // 55 8B EC 56 8B 75 08 57 8B F9 56 8B 07 FF 90 ? ? ? ?
	...
	_(set_abs_angles, "55 8B EC 83 E4 F8 83 EC 64 53"); // 55 8B EC 83 E4 F8 83 EC 64 53 56 57 8B F1 E8
	...
	_(modify_eye_pos, "55 8B EC 83 E4 F8 83 EC 18 56 57 8B F9 8B 4F"); // 85 C0 0F 84 ? ? ? ? 8B 45 08 8B 0D
