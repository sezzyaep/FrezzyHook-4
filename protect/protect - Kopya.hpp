...
namespace hs {
	...
	_(is_Line_goes_through_smoke, "55 8B EC 83 EC 08 8B 15 ? ? ? ? 0F");
	...
	_(update_clientside_anim_p, "8B ? ? ? ? ? 53 56 57 8B ? ? ? ? ? 85"); // 55 8B EC 51 56 8B F1 80 BE ?? ?? 00 00 00 74 36 8B 06 FF 90 ?? ?? 00 00
	...
	_(standard_blending_rules_p, "55 8B EC 83 E4 F0 B8 F8 10"); // 55 8B EC 83 E4 F0 B8 ? ? ? ? E8 ? ? ? ? 56 8B 75 08 57 8B F9 85 F6

	_(should_skip_anim_frame, "should_skip_anim_frame"); // should_skip_anim_frame
	_(should_skip_anim_frame_p, "57 8B F9 8B 07 8B ? ? ? ? ? FF D0 84 C0 75"); // 57 8B F9 8B 07 8B 80 ? ? ? ? FF D0 84 C0 75 02 5F C3

	_(getcswpndata, "getcswpndata"); // should_skip_anim_frame
	_(getcswpndata_p, "55 8B EC 81 EC ? ? ? ? 53 8B D9 56 57 8D 8B"); // 57 8B F9 8B 07 8B 80 ? ? ? ? FF D0 84 C0 75 02 5F C3

	_(get_cl_move, "get_cl_move"); // cl_move
	_(get_cl_move_p, "55 8B EC 81 EC ? ? ? ? 53 56 8A"); // 55 8B EC 81 EC ? ? ? ? 53 56 57 8B 3D ? ? ? ? 8A
	...
	_(setup_bones_p, "55 8B EC 83 E4 F0 B8 ? ? ? ? E8"); // 55 8B EC 83 E4 F0 B8 D8

	_(build_transformations, "build_transformations"); // build_transformations
	_(build_transformations_p, "55 8B EC 83 E4 F0 81 ? ? ? ? ? 56 57 8B F9 8B"); // 55 8B EC 83 E4 F0 81 EC ? ? ? ? 56 57 8B F9 8B 0D ? ? ? ? 89 7C 24 1C
	...
	_(create_animstate, "55 8B EC 56 8B F1 B9 ? ? ? ? C7"); // 55 8B EC 56 8B F1 B9 ? ? ? ? C7 46
	...
	_(post_think, "56 8B ? ? ? ? ? 57 8B F9 8B CE 8B 06 FF ? ? ? ? ? 8B"); // 55 8B EC 83 E4 F8 81 EC ? ? ? ? 53 8B D9
	_(simulate_player, "56 8B F1 57 8B BE ? ? ? ? 83 EF 01 78 72"); // 56 8B F1 57 8B BE ? ? ? ? 83 EF 01 78 72
	_(physics_run_think, "55 8B EC 83 EC 10 53 56 57 8B F9 8B"); // 55 8B EC 83 EC 10 53 56 57 8B F9 8B 87
	...
	_(set_clantag, "53 56 57 8B DA 8B"); // 53 56 57 8B DA 8B F9 FF 15
	...
	_(modify_eye_pos, "55 8B EC 83 E4 F8 83 EC 70 56 57 8B F9 89 7C 24 14"); // 85 C0 0F 84 ? ? ? ? 8B 45 08 8B 0D
	_(ret_engine, "85 C0 74 2D 83 7D 10 ? 75 1C"); // \x85\xC0\x74\x2D\x83\x7D\x10\x00\x75\x1C
	_(setup_vel, "55 8B EC 83 E4 F8 83 EC 30 56 57 8B ? ? ? ? ? 8B"); // 84 C0 75 38 8B 0D ? ? ? ? 8B 01 8B 80
